...
if (aiClient) {
  ...
  console.warn("Azure OpenAI not configured — using keyword fallback. Set AZURE_OPENAI_* in mock-api/.env");
}
...
app.post("/api/chat", async (req, res) => {
  ...
  res.json({
    reply: `⚠️ Azure OpenAI is not configured. Add your keys to mock-api/.env to enable AI responses.\n\nKeyword mode — try:\n• "List all clauses"\n• "Find the payment clause"\n• "Change 30 days to 60 days"`
  });
});
